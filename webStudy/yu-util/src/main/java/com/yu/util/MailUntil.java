...
public class MailUntil {
	...
	public boolean sendOut() {
		try {
			...
			if(mimeMsg.getRecipients(Message.RecipientType.CC)!=null && mimeMsg.getRecipients(Message.RecipientType.CC).length>0){
	...
	public static boolean send(String smtp, String from, String to, String subject, String content, String username,
			String password) {
		MailUntil theMail = new MailUntil(smtp);
