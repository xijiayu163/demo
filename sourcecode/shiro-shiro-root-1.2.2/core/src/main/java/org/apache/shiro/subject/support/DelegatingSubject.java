...
public class DelegatingSubject implements Subject {
    ...
    public String toString(){
    	...
    	sBuilder.append("\r\n");
    	sBuilder.append("principals:"+principals+"\r\n");
    	sBuilder.append("authenticated:"+authenticated+"\r\n");
    	sBuilder.append("host:"+host+"\r\n");
    	sBuilder.append("session:"+session+"\r\n");
    	sBuilder.append("sessionCreationEnabled:"+sessionCreationEnabled+"\r\n");
    	sBuilder.append("securityManager:"+securityManager+"\r\n");
