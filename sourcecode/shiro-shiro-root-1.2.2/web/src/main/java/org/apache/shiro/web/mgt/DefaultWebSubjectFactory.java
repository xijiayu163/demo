...
public class DefaultWebSubjectFactory extends DefaultSubjectFactory {
    ...
    public Subject createSubject(SubjectContext context) {
        ...
        log.info("解析context。。。。");
        log.info("获取securityManager:"+securityManager);
        log.info("获取Session:"+session);
        log.info("获取sessionEnabled:"+sessionEnabled);
        log.info("获取principals:"+principals);
        log.info("获取authenticated:"+authenticated);
        log.info("获取host:"+host);
        log.info("获取ServletRequest:"+request);
        log.info("获取ServletResponse:"+response);
        log.info("根据这些数据构建一个WebDelegatingSubject");
